...
module.exports = {
  ...
  collectCoverageFrom: [
    ...
    // SettingsTab + the modal UI shells are DOM-heavy and exercised by the
    // dev harness and manual QA in Obsidian; including them in coverage
    // targets would push us toward brittle DOM-snapshot tests for low value.
